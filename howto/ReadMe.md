...
##The beginning
You have your fluksometer up and running with the newest firmware version (latest is 2.5.0) and know its local IP address; in this example I will use `192.168.0.114`. When accessing this address in a browser, you will get following display.
...
As an alternative, download the corresponding zip-file from [http://github.com/gebhardm/flmlocal](https://github.com/gebhardm/flmlocal/archive/flm02.zip) and unpack it to a folder you know.

##Changing directory to the files to copy
Attention: In the meanwhile there are two hardware versions of the Fluksometer out in the wildlife; as we here deal with the version 2 of the Fluksometer, you have to switch to the FLM02 branch of the repository. Do so by executing
